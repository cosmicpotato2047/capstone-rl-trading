...
|---|---|---|---|
| **ATR Baseline** | **1.378** | — | Env-v4 Bayesian Trial #34 |
| **RL sym (exp030 + 안정화)** | **1.974** | **+24%** | symmetric reward, 1M steps 완주 |
...
| Variant | Best Trial | Best Params | Val Sharpe (200k single-seed) | vs ATR (1.378) |
|---|---|---|---|---|
...
**모든 4 variant 가 ATR baseline 을 best 기준 +21~36% 초과.** 단 4 metric 1위가 모두 다름.
...
- **H1** (sym ≈ ATR): 부정 — sym best Sharpe 1.871 >> ATR 1.378
...
- Env-v4 (2D ATR 비례, asym β=3.42): Val Sharpe 1.681 (ATR 1.378 대비 **+12%**, sym 보다 낮음)
...
**Menu 1 — Pareto scatter**: 40 RL runs 가 Sharpe-MDD 평면에서 **두 cluster 형성, 5 개 Pareto frontier**. ATR (9.83, 1.378) 은 완전 dominated. → **§5 메인 figure 1순위**
...
| Variant | exp033 Sharpe ± std | vs exp032b | Cohen's d | Slippage retention | vs ATR 1.378 |
|---|---|---|---|---|---|
...
#### ATR Baseline Test: **Sharpe -0.055** (Val 1.378 → -1.56 gap)
