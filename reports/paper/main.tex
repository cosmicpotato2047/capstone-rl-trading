...
\graphicspath{{figures/}{../exp032b/figures/}{../exp032c/figures/}{../exp033/figures/}{../exp034/figures/}{../exp035/figures/}{../phase15/figures/}{../phase16d/figures/}}
...
rather than a single Sharpe ``alpha source.'' Second, we provide, to our
knowledge, the first quantitative evidence that Kahneman-Tversky prospect
theory confers out-of-distribution safety on RL trading policies. Code and data:
...
failure recovers under DR---i.e., whether the dual face of the same reward
can be dissolved by DR.
\end{itemize}
