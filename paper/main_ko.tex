...
더 붉어 path 간 일관된 우위를 보이며, \texttt{asym/pt}는 진파랑(p14에서 $0.50$)과
...
분포 모양은 유사하지만 Test 평균이 약간 양의 방향으로 이동 ($+0.024\%$ vs $-0.007\%$)
— bull regime 반영. 두 통계 모두 KS 검정 $p < 10^{-10}$로 매우 유의.}
